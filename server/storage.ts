...
export class MemStorage implements IStorage {
  ...
  async getContentSections(): Promise<ContentSection[]> {
    return Array.from(this.contentSections.values()).sort(
      (a, b) =>
  ...
  async createContentSection(
    insertContent: InsertContentSection,
  ...
  async createPropertyImage(
    insertImage: InsertPropertyImage,
  ...
  async updatePropertyImage(
    id: string,
    updateData: Partial<PropertyImage>,
  ): Promise<PropertyImage | undefined> {
  ...
  private async initializeDefaultContent() {
    ...
    await this.createContentSection({
      ...
      title: "Hero Title",
      content: "Casa Rondini Istrian Villa Retreat",
    ...
    await this.createContentSection({
      ...
      content: "Contemporary Luxury Istrian Villa",
      metadata: JSON.stringify({ editable: true, type: "text" }),
    });
    ...
    const interiorImages = [
      {
        url: "https://demo-source.imgix.net/plant.jpg",
        title: "Living Room",
        description: "Open-concept design with panoramic views",
      },
      {
        url: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
        title: "Master Suite",
        description: "King bed with stunning ocean views",
      },
      {
        url: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
        title: "Gourmet Kitchen",
        description: "Professional-grade appliances",
      },
      {
        url: "https://images.unsplash.com/photo-1620626011761-996317b8d101?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
        title: "Spa Bathroom",
        description: "Marble finishes and soaking tub",
      },
    ];
    ...
    const amenityImages = [
      {
        url: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
        title: "Infinity Pool & Spa",
        description:
          "Relax in our stunning infinity pool with panoramic ocean views",
      },
      {
        ...
        description: "Stay active in our fully equipped private gym",
      },
    ];
